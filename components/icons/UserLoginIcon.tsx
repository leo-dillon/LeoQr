...
export default function UserLoginIcon({ size = 24, color = "currentColor", className = "", ...props }: IconsTypes) {
  return (
    <svg 
        ...
        viewBox="0 0 24 24" 
        fill='none'
        className={`icon icon-tabler icons-tabler-outline icon-tabler-user-pentagon ${className}`}
        stroke="currentColor" 
        strokeWidth="2" 
        strokeLinecap="round" 
